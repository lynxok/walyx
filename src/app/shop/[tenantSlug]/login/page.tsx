...
import { ArrowLeft, Loader2, Lock, Mail, Phone, User, Check } from "lucide-react";
import { getTenantBySlug } from "@/app/actions/tenant";
import { loginGlobalUser, registerGlobalUser } from "@/app/actions/auth";
...
export default function ShopLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (res.success) {
      setSuccess(isRegister ? "Cuenta creada con éxito. Redirigiendo..." : "Sesión iniciada con éxito. Redirigiendo...");
      setTimeout(() => {
